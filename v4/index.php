                        ...
                        <div id="form_box" class="form_box">
                            ...
                            <form id="msform" class="form" action="thank-you.php?" novalidate method="post">
                                ...
                                <fieldset id="form-step1" class="form-steps fieldset-0" data-step="1" style="display: block;" data-tag="homeowner">
                                    ...
                                    <h3 class="form_box-question">¿Es usted dueño de una propiedad?</h3>
                                ...
                                <fieldset id="form-step3" class="form-steps fieldset-2" data-step="3" style="display: none;" data-tag="utilityprovider">
                                    <legend hidden="true">Utilidad</legend>
                                    <h3 class="form_box-question">¿Cuál es su proveedor de electricidad?</h3>
                                    <div class="form-group">
                                        <label for="provider-select" class="label" style="visibility: hidden; position: absolute;">
                                            ¿Cuál es su proveedor? </label>
                                ...
                                <fieldset id="form-step4" class="form-steps fieldset-3" data-step="4" style="display: none;" data-tag="utilitybill">
                                    <legend hidden="true">Factura Eléctrica</legend>
                                    <h3 class="form_box-question">¿Cuánto es el promedio mensual de su factura eléctrica?</h3>
                                    <div class="form-group">
                                        <div class="bill_bar">
                                            <div class="box_range">
                                ...
                                <fieldset id="form-step5" class="form-steps fieldset-4" data-step="5" style="display: none;" data-tag="roofshade">
                                    <legend hidden="true">Exposición al sol del techo</legend>
                                    ...
                                    <div class="form-group radio-next">
                                        <div class="radio-btn">
                                            ...
                                            <label for="rf1"><span>Completamente soleado</span></label>
                                        </div>
                                        <div class="radio-btn">
                                        ...
                                        <div class="radio-btn">
                                            ...
                                            <label for="rf4"><span>Incierto</span></label>
                                        </div>
                                        <div class="form-error-message">Pros necesitan esta información para generar una cita. </div>
                                    </div>
                                    <div class="row">
                                        <div class="col col-xs-6 colback"><a class="btn btn-link btn-back">Atrás</a></div>
                                        <div class="col col-xs-6">
                                ...
                                <fieldset id="form-step6" class="form-steps fieldset-5" data-step="6" style="display: none;" data-tag="email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="email_error" class="form-error-message">Por favor, ingrese un e-mail válido.</div>
                                    </div>
                                    <div class="row">
                                ...
                                <fieldset id="form-step7" class="form-steps fieldset-6" data-step="7" style="display: none;" data-tag="first">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="first_error" class="form-error-message">Por favor, ingrese su nombre.</div>
                                    </div>
                                    <div class="row">
                                        <div class="col colback"><a class="btn btn-link btn-back">Atrás</a></div>
                                        <div class="col">
                                ...
                                <fieldset id="form-step11" class="form-steps fieldset-11" data-step="11" style="display: none;" data-tag="phone">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="phone_error" class="form-error-message phone-valid-error">Por favor, ingrese un número de teléfono Estado Unidense válido.</div>
                                    </div>
                                    <span class="terms_txt">
                                        <label id="tcpa_label">
                                            <input type="hidden" id="leadid_tcpa_disclosure" />
                                            Respetamos su privacidad y queremos informarle algunas cosas. Al presionar “Siguiente”, autorizas a For the Deal y hasta
                                            <a href="companylist.php" target="_blank">cuatro compañías solares</a>, sujeto a nuestras <a href="privacy.php" target="_new"> Politicas de Privacidad<a> y nuestros <a href="terms.php" target="_new">Términos y Condiciones</a>
                                            para llamarlo o enviarle un mensaje SMS al número de teléfono proporcionado, incluso si actualmente figura en cualquier lista estatal, federal o corporativa de "No llamar", y usted comprende que pueden usar marcación automática o mensajes pregrabados para llamarlo, y que No se requiere su consentimiento para comprar productos o servicios.
                                        </label>
                                    </span>
                                    <div class="row">
        ...
        <div class="modal-content">
            ...
            <div class="tcpa-content-container">
                <div id="terms-php" class="hidden">
                    <h2 id="terms-php-top">Términos de uso</h2>

                    <p>Efectivo Junio 1ro, 2023</p>
                    <p>Última actualización Junio 6, 2023</p>

                    <p>Bienvenid@ a gogreenandsave.net!</p>

                    <p>Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de For the Deal, ubicado en https://gogreenandsave.net/.</p>

                    <p>Al acceder a este sitio web asumimos que acepta estos términos y condiciones. No continúe usando gogreenandsave.net si no acepta todos los términos y condiciones establecidos en esta página.</p>

                    <p>La siguiente terminología se aplica a estos Términos y condiciones, Declaración de privacidad y Aviso de exención de responsabilidad y a todos los Acuerdos: "Cliente", "Usted" y "Su" se refieren a usted, la persona que inicia sesión en este sitio web y cumple con los términos y condiciones de la Compañía. "La Compañía", "Nosotros mismos", "Nosotros", "Nuestro" y "Nos", se refieren a nuestra Compañía. "Parte", "Partes" o "Nosotros" se refieren tanto al Cliente como a nosotros mismos. Todos los términos se refieren a la oferta, aceptación y consideración del pago necesario para llevar a cabo el proceso de nuestra asistencia al Cliente de la manera más adecuada con el propósito expreso de satisfacer las necesidades del Cliente con respecto a la prestación de los servicios indicados por la Compañía, de acuerdo con y sujeto a la ley vigente en nosotros. Cualquier uso de la terminología anterior u otras palabras en singular, plural, mayúsculas y/o él/ella o ellos, se consideran intercambiables y por lo tanto se refieren a las mismas.</p>

                    <h3><strong>Cookies</strong></h3>

                    <p>Empleamos el uso de cookies. Al acceder a gogreenandsave.net, acepta utilizar cookies de acuerdo con For the Deal's<a href="privacy-policy.php" target="_new">Políticas de Privacidad</a>. </p>
                    ...
                    <p>A menos que se indique lo contrario, For the Deal y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material de gogreenandsave.net. Todos los derechos de propiedad intelectual están reservados. Puede acceder a esto desde gogreenandsave.net para su uso personal sujeto a las restricciones establecidas en estos términos y condiciones.</p>

                    <p>No debes:</p>
                    <ul>
                        <li>Volver a publicar material de gogreenandsave.net</li>
                        <li>Vender, alquilar o sublicenciar material de gogreenandsave.net</li>
                        <li>Reproducir, duplicar o copiar material de gogreenandsave.net</li>
                        <li>Redistribuir contenido de gogreenandsave.net</li>
                    </ul>

                    <p>Este Acuerdo comenzará en la fecha del presente. Nuestros Términos y condiciones fueron creados con la ayuda de <a href="https://www.termsandconditionsgenerator.com/">Generador gratuito de términos y condiciones</a>.</p>

                    <p>Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas del sitio web. For the Deal no filtra, edita, publica ni revisa los Comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista y opiniones de For the Deal, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica sus puntos de vista y opiniones. En la medida permitida por las leyes aplicables, For the Deal no será responsable de los Comentarios ni de ninguna responsabilidad, daños o gastos causados ​​y/o sufridos como resultado de cualquier uso, publicación y/o apariencia de los Comentarios. en este sitio web.</p>

                    <p>For the Deal se reserva el derecho de monitorear todos los Comentarios y eliminar cualquier Comentario que pueda considerarse inapropiado, ofensivo o que infrinja estos Términos y condiciones.</p>

                    <p>Usted garantiza y declara que:</p>

                    <ul>
                        <li>Tiene derecho a publicar Comentarios en nuestro sitio web y tiene todas las licencias y consentimientos necesarios para hacerlo;</li>
                        <li>Los Comentarios no invaden ningún derecho de propiedad intelectual, incluidos, entre otros, derechos de autor, patentes o marcas comerciales de terceros;</li>
                        ...
                        <li>Los Comentarios no se utilizarán para solicitar o promover negocios o costumbres o presentar actividades comerciales o actividades ilegales.</li>
                    </ul>

                    <p>Por la presente, otorga a For the Deal una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de sus Comentarios en todas y cada una de las formas, formatos o medios.</p>
                    ...
                    <ul>
                        ...
                        <li>Los distribuidores de directorios en línea pueden vincularse a nuestro sitio web de la misma manera que lo hacen a los sitios web de otras empresas enumeradas; y</li>
                        <li>Empresas acreditadas en todo el sistema, excepto aquellas que soliciten servicios a organizaciones sin fines de lucro, centros comerciales benéficos y grupos de recaudación de fondos benéficos que no pueden tener hipervínculos a nuestro sitio web.</li>
                    </ul>

                    <p>Estas organizaciones pueden vincularse a nuestra página de inicio, a publicaciones u otra información del sitio web siempre que el vínculo: (a) no sea de ninguna manera engañoso; (b) no implica falsamente patrocinio, respaldo o aprobación de la parte vinculadora y sus productos y/o servicios; y (c) se ajusta al contexto del sitio de la parte vinculadora.</p>
                    ...
                    <p>Aprobaremos las solicitudes de enlace de estas organizaciones si decidimos que: (a) el enlace no nos hará vernos desfavorablemente a nosotros mismos o a nuestras empresas acreditadas; (b) la organización no tiene ningún registro negativo con nosotros; (c) el beneficio para nosotros de la visibilidad del hipervínculo compensa la ausencia de For the Deal; y (d) el enlace está en el contexto de información de recursos generales.</p>

                    <p>Estas organizaciones pueden vincularse a nuestra página de inicio siempre que el vínculo: (a) no sea de ninguna manera engañoso; (b) no implica falsamente patrocinio, respaldo o aprobación de la parte vinculadora y sus productos o servicios; y (c) se ajusta al contexto del sitio de la parte vinculadora.</p>

                    <p>Si usted es una de las organizaciones enumeradas en el párrafo 2 anterior y está interesado en vincularse a nuestro sitio web, debe informarnos enviando un correo electrónico a For the Deal. Incluya su nombre, el nombre de su organización, información de contacto, así como la URL de su sitio, una lista de las URL desde las que desea vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que le gustaría acceder. enlace. Espere de 2 a 3 semanas para recibir una respuesta.</p>
                    ...
                    <ul>
                        ...
                        <li>Mediante el uso de cualquier otra descripción de nuestro sitio web al que se vincula que tenga sentido dentro del contexto y formato del contenido del sitio de la parte vinculadora.</li>
                    </ul>

                    <p>No se permitirá el uso del logotipo de For the Deal u otras ilustraciones para vincular sin un acuerdo de licencia de marca registrada.</p>
                    ...
                    <p>No seremos responsables de ningún contenido que aparezca en su sitio web. Usted acepta protegernos y defendernos contra todos los reclamos que surjan en su sitio web. No deben aparecer enlaces en ningún sitio web que puedan interpretarse como difamatorios, obscenos o criminales, o que infrinjan, violen o defiendan la infracción u otra violación de derechos de terceros.</p>
                    ...
                    <p>No garantizamos que la información contenida en este sitio web sea correcta, no garantizamos su integridad o exactitud; ni nos comprometemos a garantizar que el sitio web permanezca disponible o que el material del sitio web se mantenga actualizado.</p>
                    ...
                    <ul>
                        ...
                        <li>limitar cualquiera de nuestras responsabilidades o las suyas de cualquier forma que no esté permitida por la ley aplicable; o</li>
                    ...
                    <p>Siempre que el sitio web y la información y los servicios del sitio web se proporcionen de forma gratuita, no seremos responsables de ninguna pérdida o daño de cualquier naturaleza.</p>
                ...
                <div id="privacy-php" class="hidden">
                    <h2 id="privacy-php-top">Políticas de Privacidad</h2>
                    <p>A partir del 1 de junio de 2023</p>
                    <p>Última actualización el 6 de junio de 2023</p>
                    <h1>Política de privacidad para For the Deal</h1>

                    <p>En gogreenandsave.net, accesible desde https://gogreenandsave.net/, una de nuestras principales prioridades es la privacidad de nuestros visitantes. Este documento de Política de privacidad contiene tipos de información que gogreenandsave.net recopila y registra y cómo la usamos.</p>
                    ...
                    <p>Esta Política de Privacidad se aplica únicamente a nuestras actividades en línea y es válida para los visitantes de nuestro sitio web con respecto a la información que compartieron y/o recopilaron en gogreenandsave.net. Esta política no se aplica a ninguna información recopilada fuera de línea o a través de canales distintos de este sitio web.</p>

                    <h2>Consentimiento</h2>

                    <p>Al utilizar nuestro sitio web, por la presente usted acepta nuestra Política de privacidad y acepta sus términos.</p>

                    <h2>Información que recopilamos</h2>

                    <p>La información personal que se le solicita que proporcione y los motivos por los que se le solicita que la proporcione se le aclararán en el momento en que le solicitemos que proporcione su información personal.</p>
                    ...
                    <p>Cuando se registra para obtener una cuenta, es posible que le solicitemos su información de contacto, incluidos elementos como nombre, nombre de la empresa, dirección, dirección de correo electrónico y número de teléfono.</p>

                    <h2>Cómo utilizamos su información</h2>

                    <p>Utilizamos la información que recopilamos de varias maneras, incluso para:</p>
                    ...
                    <li>Comunicarnos con usted, ya sea directamente o a través de uno de nuestros socios, incluso para el servicio de atención al cliente, para proporcionarle actualizaciones y otra información relacionada con el sitio web y con fines promocionales y de marketing.</li>
                    <li>Enviarle correos electrónicos</li>
                    <li>Encontrar y prevenir el fraude</li>
                    </ul>

                    <h2>Exclusión voluntaria</h2>

                   <p>Si, después de haber compartido su información con nosotros, decide que no desea recibir comunicaciones de marketing del Proveedor, puede interrumpir las comunicaciones enviando una solicitud de exclusión voluntaria a la información de Contáctenos que se detalla a continuación</p >

                    <h2>Archivos de registro</h2>

                    <p>gogreenandsave.net sigue un procedimiento estándar de uso de archivos de registro. Estos archivos registran a los visitantes cuando visitan sitios web. Todas las empresas de hosting hacen esto y forman parte del análisis de los servicios de hosting. La información recopilada por los archivos de registro incluye direcciones de protocolo de Internet (IP), tipo de navegador, proveedor de servicios de Internet (ISP), marca de fecha y hora, páginas de referencia/salida y posiblemente la cantidad de clics. Estos no están vinculados a ninguna información que sea de identificación personal. El propósito de la información es analizar tendencias, administrar el sitio, rastrear el movimiento de los usuarios en el sitio web y recopilar información demográfica.</p>

                    <h2>Cookies y balizas web</h2>

                    <p>Como cualquier otro sitio web, gogreenandsave.net utiliza "cookies". Estas cookies se utilizan para almacenar información, incluidas las preferencias de los visitantes y las páginas del sitio web a las que el visitante accedió o visitó. La información se utiliza para optimizar la experiencia de los usuarios personalizando el contenido de nuestra página web según el tipo de navegador de los visitantes y/u otra información.</p>

                    <h2>Políticas de privacidad de los socios publicitarios</h2>

                    <P>Puede consultar esta lista para encontrar la Política de Privacidad de cada uno de los socios publicitarios de gogreenandsave.net.</p>

                    <p>Los servidores o redes publicitarias de terceros utilizan tecnologías como cookies, JavaScript o Web Beacons que se utilizan en sus respectivos anuncios y enlaces que aparecen en gogreenandsave.net, que se envían directamente al navegador de los usuarios. Reciben automáticamente su dirección IP cuando esto ocurre. Estas tecnologías se utilizan para medir la eficacia de sus campañas publicitarias y/o para personalizar el contenido publicitario que ve en los sitios web que visita.</p>

                    <p>Tenga en cuenta que gogreenandsave.net no tiene acceso ni control sobre estas cookies que utilizan los anunciantes externos.</p>

                    <h2>Políticas de privacidad de terceros</h2>

                    <p>La Política de Privacidad de gogreenandsave.net no se aplica a otros anunciantes o sitios web. Por lo tanto, le recomendamos que consulte las respectivas Políticas de Privacidad de estos servidores de anuncios de terceros para obtener información más detallada. Puede incluir sus prácticas e instrucciones sobre cómo darse de baja de ciertas opciones. </p>

                    <p>Puede optar por desactivar las cookies a través de las opciones individuales de su navegador. Para conocer información más detallada sobre la gestión de cookies con navegadores web específicos, puede encontrarla en los sitios web respectivos de los navegadores.</p>

                    <h2>Derechos de Protección de Datos GDPR</h2>

                    <p>Nos gustaría asegurarnos de que usted conoce plenamente todos sus derechos de protección de datos. Todo usuario tiene derecho a lo siguiente:</p>
                    ...
                    <p>El derecho a la rectificación: tiene derecho a solicitar que corrijamos cualquier información que considere inexacta. También tiene derecho a solicitar que completemos la información que crea que está incompleta.</p>
                    ...
                    <p>gogreenandsave.net no recopila intencionalmente ninguna información de identificación personal de niños menores de 13 años. Si cree que su hijo proporcionó este tipo de información en nuestro sitio web, le recomendamos encarecidamente que se comunique con nosotros de inmediato y haremos todo lo posible. mejores esfuerzos para eliminar rápidamente dicha información de nuestros registros.</p>

                    <h2>Cambios en esta política de privacidad</h2>

                    <p>Podemos actualizar nuestra Política de Privacidad de vez en cuando. Por lo tanto, le recomendamos que revise esta página periódicamente para detectar cualquier cambio. Le notificaremos cualquier cambio publicando la nueva Política de Privacidad en esta página. Estos cambios entran en vigor inmediatamente después de su publicación en esta página.</p>

                    <p>Si tienes alguna pregunta o sugerencia sobre nuestra Política de Privacidad, no dudes en contactar con nosotros.</p>
                ...
                <div id="ccpa-php" class="hidden">
                    <h2 id="ccpa-php-top">Derechos de privacidad CCPA (no vender mi información personal)</h2>

                    <p>Según la CCPA, entre otros derechos, los consumidores de California tienen derecho a:</p>
                    <p>Solicitar que una empresa que recopila datos personales de un consumidor revele las categorías y datos personales específicos que una empresa ha recopilado sobre los consumidores.</p>
                    <p>Solicitar que una empresa elimine cualquier dato personal sobre el consumidor que haya recopilado.</p>
                    <p>Solicitar que una empresa que vende datos personales de un consumidor no venda los datos personales del consumidor.</p>
                    <p>Si realiza una solicitud, tenemos un mes para responderle. Si desea ejercer alguno de estos derechos, póngase en contacto con nosotros.</p>
                    <style>
                        strong {
                            font-weight: bold;
                ...
                <div id="contact_us-php" class="hidden">
                    <h2 id="contact_us-php-top">Contáctenos</h2>
                    <p>Si tiene alguna pregunta o necesita apoyo con respecto a nuestras políticas, no dude en contactarnos a través del siguiente correo electrónico: luis@forthedeal.com <br>o en nuestra dirección postal: 33 sw 2nd ave suite 802 <br>
                    Manejamos los correos electrónicos durante nuestro horario comercial normal. Incluya su nombre completo y código postal en su consulta.
                    </p>
                    <style>
                        strong {
                            font-weight: bold;
                                    ...
                                    .done(function(res) {
                                        ...
                                        postCall("https://receiver.ceeleads.info/leads/post2", data).then(x => x.json()).then(x => {
                                            ...
                                            if (
                                                ...
                                                fetch(`https://www.ecomfylk.com/?nid=1006&oid=1408&affid=224&amount=${payout}`).then(
